...
Now it's deprecated in favor of separate inclusion of required parts of `@dramaorg/asperiores-optio-earum` and `regenerator-runtime` and, for preventing breaking changes, left on `@dramaorg/asperiores-optio-earum@2`.
...
The main part of `String` features: modules [`es.string.from-code-point`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.from-code-point.js), [`es.string.raw`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.raw.js), [`es.string.iterator`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.iterator.js), [`es.string.split`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.split.js), [`es.string.code-point-at`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.code-point-at.js), [`es.string.ends-with`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.ends-with.js), [`es.string.includes`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.includes.js), [`es.string.repeat`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.repeat.js), [`es.string.pad-start`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.pad-start.js), [`es.string.pad-end`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.pad-end.js), [`es.string.starts-with`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.starts-with.js), [`es.string.trim`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.trim.js), [`es.string.trim-start`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.trim-start.js), [`es.string.trim-end`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.trim-end.js), [`es.string.match-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.match-all.js), [`es.string.replace-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.replace-all.js), [`es.string.at-alternative`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.at-alternative.js), [`es.string.is-well-formed`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.is-well-formed.js), [`es.string.to-well-formed`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.string.to-well-formed.js).
...
```
Modules [`es.number.epsilon`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.parse-int.js), [`es.parse-float`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.parse-float.js).
```js
class Number {
...
Modules [`es.symbol`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/async-iterator
@dramaorg/asperiores-optio-earum/es|stable|actual|full/symbol/description
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/has-instance
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/iterator
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/match
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/replace
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/search
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/species
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/split
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/to-primitive
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/to-string-tag
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/unscopables
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/for
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/symbol/key-for
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/object/get-own-property-symbols
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@dramaorg/asperiores-optio-earum` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@dramaorg/asperiores-optio-earum` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.map.js) and [`es.map.group-by`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/map
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.js), [`es.set.difference.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/difference
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/intersection
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/is-disjoint-from
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/is-subset-of
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/is-superset-of
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/symmetric-difference
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/constructor
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/is-view
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/detached
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/slice
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/transfer
@dramaorg/asperiores-optio-earum/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@dramaorg/asperiores-optio-earum/es|stable|actual|full/data-view
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/int8-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/uint8-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/uint8-clamped-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/int16-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/uint16-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/int32-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/uint32-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/float32-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/float64-array
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/at
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/copy-within
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/entries
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/every
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/fill
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/filter
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/find
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/find-index
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/find-last
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/find-last-index
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/for-each
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/from
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/includes
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/index-of
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/iterator
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/join
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/keys
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/last-index-of
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/map
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/of
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/reduce
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/reduce-right
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/reverse
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/set
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/slice
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/some
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/sort
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/subarray
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/to-locale-string
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/to-reversed
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/to-sorted
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/to-string
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/values
@dramaorg/asperiores-optio-earum/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/apply
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/construct
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/define-property
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/delete-property
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/get
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/get-prototype-of
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/has
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/is-extensible
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/own-keys
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/prevent-extensions
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/set
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@dramaorg/asperiores-optio-earum` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/json/stringify
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@dramaorg/asperiores-optio-earum` as stable ECMAScript, they are available in `@dramaorg/asperiores-optio-earum/stable` and `@dramaorg/asperiores-optio-earum/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@dramaorg/asperiores-optio-earum` provides a way to include only features for a specific proposal like `@dramaorg/asperiores-optio-earum/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/change-array-by-copy-stage-4
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@dramaorg/asperiores-optio-earum(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@dramaorg/asperiores-optio-earum/stage/3` entry point contains only stage 3 proposals, `@dramaorg/asperiores-optio-earum/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/iterator-helpers-stage-3-2
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/drop
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/every
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/filter
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/find
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/flat-map
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/for-each
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/from
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/map
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/reduce
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/some
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/take
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/array-from-async-stage-2
@dramaorg/asperiores-optio-earum(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/json-parse-with-source
@dramaorg/asperiores-optio-earum(-pure)/actual|full/json/is-raw-json
@dramaorg/asperiores-optio-earum(-pure)/actual|full/json/parse
@dramaorg/asperiores-optio-earum(-pure)/actual|full/json/raw-json
@dramaorg/asperiores-optio-earum(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/float16
@dramaorg/asperiores-optio-earum/actual|full/dataview/get-float16
@dramaorg/asperiores-optio-earum/actual|full/dataview/set-float16
@dramaorg/asperiores-optio-earum/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/array-buffer-base64
@dramaorg/asperiores-optio-earum(-pure)/full/typed-array/from-base64
@dramaorg/asperiores-optio-earum(-pure)/full/typed-array/from-hex
@dramaorg/asperiores-optio-earum(-pure)/full/typed-array/to-base64
@dramaorg/asperiores-optio-earum(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/explicit-resource-management
@dramaorg/asperiores-optio-earum(-pure)/actual|full/symbol/async-dispose
@dramaorg/asperiores-optio-earum(-pure)/actual|full/symbol/dispose
@dramaorg/asperiores-optio-earum(-pure)/actual|full/disposable-stack
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-disposable-stack
@dramaorg/asperiores-optio-earum(-pure)/actual|full/suppressed-error
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/dispose
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/decorator-metadata-v2
@dramaorg/asperiores-optio-earum(-pure)/actual|full/symbol/metadata
@dramaorg/asperiores-optio-earum(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/promise-try
@dramaorg/asperiores-optio-earum(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/math-sum
@dramaorg/asperiores-optio-earum(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/async-iterator-helpers
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/drop
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/every
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/filter
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/find
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/flat-map
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/for-each
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/from
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/map
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/reduce
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/some
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/take
@dramaorg/asperiores-optio-earum(-pure)/actual|full/async-iterator/to-array
@dramaorg/asperiores-optio-earum(-pure)/actual|full/iterator/to-async
```
...
- Now, we have access to the real `%AsyncIteratorPrototype%` only with usage async generators syntax. So, for compatibility of the library with old browsers, we should use `Function` constructor. However, that breaks compatibility with CSP. So, if you wanna use the real `%AsyncIteratorPrototype%`, you should set `USE_FUNCTION_CONSTRUCTOR` option in the `@dramaorg/asperiores-optio-earum/configurator` to `true`:
```js
const configurator = require('@dramaorg/asperiores-optio-earum/configurator');

configurator({ USE_FUNCTION_CONSTRUCTOR: true });

require('@dramaorg/asperiores-optio-earum/actual/async-iterator');

(async function * () { /* empty */ })() instanceof AsyncIterator; // => true
```
- As an alternative, you could pass to the `@dramaorg/asperiores-optio-earum/configurator` an object that will be considered as `%AsyncIteratorPrototype%`:
```js
const configurator = require('@dramaorg/asperiores-optio-earum/configurator');
...
Module [`esnext.iterator.range`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/number-range
@dramaorg/asperiores-optio-earum(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/map-upsert-stage-2
@dramaorg/asperiores-optio-earum(-pure)/full/map/emplace
@dramaorg/asperiores-optio-earum(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/array-is-template-object
@dramaorg/asperiores-optio-earum(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-dedent
@dramaorg/asperiores-optio-earum(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/regexp-escaping
@dramaorg/asperiores-optio-earum(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/symbol-predicates-v2
@dramaorg/asperiores-optio-earum(-pure)/full/symbol/is-registered-symbol
@dramaorg/asperiores-optio-earum(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/observable
@dramaorg/asperiores-optio-earum(-pure)/full/observable
@dramaorg/asperiores-optio-earum(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/collection-methods
@dramaorg/asperiores-optio-earum/proposals/collection-of-from
@dramaorg/asperiores-optio-earum(-pure)/full/set/add-all
@dramaorg/asperiores-optio-earum(-pure)/full/set/delete-all
@dramaorg/asperiores-optio-earum(-pure)/full/set/every
@dramaorg/asperiores-optio-earum(-pure)/full/set/filter
@dramaorg/asperiores-optio-earum(-pure)/full/set/find
@dramaorg/asperiores-optio-earum(-pure)/full/set/from
@dramaorg/asperiores-optio-earum(-pure)/full/set/join
@dramaorg/asperiores-optio-earum(-pure)/full/set/map
@dramaorg/asperiores-optio-earum(-pure)/full/set/of
@dramaorg/asperiores-optio-earum(-pure)/full/set/reduce
@dramaorg/asperiores-optio-earum(-pure)/full/set/some
@dramaorg/asperiores-optio-earum(-pure)/full/map/delete-all
@dramaorg/asperiores-optio-earum(-pure)/full/map/every
@dramaorg/asperiores-optio-earum(-pure)/full/map/filter
@dramaorg/asperiores-optio-earum(-pure)/full/map/find
@dramaorg/asperiores-optio-earum(-pure)/full/map/find-key
@dramaorg/asperiores-optio-earum(-pure)/full/map/from
@dramaorg/asperiores-optio-earum(-pure)/full/map/includes
@dramaorg/asperiores-optio-earum(-pure)/full/map/key-by
@dramaorg/asperiores-optio-earum(-pure)/full/map/key-of
@dramaorg/asperiores-optio-earum(-pure)/full/map/map-keys
@dramaorg/asperiores-optio-earum(-pure)/full/map/map-values
@dramaorg/asperiores-optio-earum(-pure)/full/map/merge
@dramaorg/asperiores-optio-earum(-pure)/full/map/of
@dramaorg/asperiores-optio-earum(-pure)/full/map/reduce
@dramaorg/asperiores-optio-earum(-pure)/full/map/some
@dramaorg/asperiores-optio-earum(-pure)/full/map/update
@dramaorg/asperiores-optio-earum(-pure)/full/weak-set/add-all
@dramaorg/asperiores-optio-earum(-pure)/full/weak-set/delete-all
@dramaorg/asperiores-optio-earum(-pure)/full/weak-set/of
@dramaorg/asperiores-optio-earum(-pure)/full/weak-set/from
@dramaorg/asperiores-optio-earum(-pure)/full/weak-map/delete-all
@dramaorg/asperiores-optio-earum(-pure)/full/weak-map/of
@dramaorg/asperiores-optio-earum(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/keys-composition
@dramaorg/asperiores-optio-earum(-pure)/full/composite-key
@dramaorg/asperiores-optio-earum(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-filtering-stage-1
@dramaorg/asperiores-optio-earum(-pure)/full/array(/virtual)/filter-reject
@dramaorg/asperiores-optio-earum/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/array-unique
@dramaorg/asperiores-optio-earum(-pure)/full/array(/virtual)/unique-by
@dramaorg/asperiores-optio-earum/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/data-view-get-set-uint8-clamped
@dramaorg/asperiores-optio-earum/full/dataview/get-uint8-clamped
@dramaorg/asperiores-optio-earum/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/number-from-string
@dramaorg/asperiores-optio-earum(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-cooked
@dramaorg/asperiores-optio-earum(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/string-code-points
@dramaorg/asperiores-optio-earum(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/pattern-matching-v2
@dramaorg/asperiores-optio-earum(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/pattern-extractors
@dramaorg/asperiores-optio-earum(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@dramaorg/asperiores-optio-earum/proposals/function-demethodize
@dramaorg/asperiores-optio-earum(-pure)/full/function/demethodize
@dramaorg/asperiores-optio-earum(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/function-is-callable-is-constructor
@dramaorg/asperiores-optio-earum(-pure)/full/function/is-callable
@dramaorg/asperiores-optio-earum(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/reflect-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/define-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/delete-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/get-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/get-metadata-keys
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/get-own-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/get-own-metadata-keys
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/has-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/has-own-metadata
@dramaorg/asperiores-optio-earum(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.atob.js), [`web.btoa`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/atob
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @dramaorg/asperiores-optio-earum');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @dramaorg/asperiores-optio-earum'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/set-timeout
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/set-immediate
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url.js), [`web.url.can-parse`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum/proposals/url
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/url
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/url/can-parse
@dramaorg/asperiores-optio-earum/stable|actual|full/url/to-json
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@dramaorg/asperiores-optio-earum` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@dramaorg/asperiores-optio-earum`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/dom-exception
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/dom-exception/constructor
@dramaorg/asperiores-optio-earum/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/dramaorg/asperiores-optio-earum/blob/master/packages/@dramaorg/asperiores-optio-earum/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum(-pure)/stable|actual|full/dom-collections/iterator
@dramaorg/asperiores-optio-earum/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@dramaorg/asperiores-optio-earum-pure/es|stable|actual|full/is-iterable
@dramaorg/asperiores-optio-earum-pure/es|stable|actual|full/get-iterator
@dramaorg/asperiores-optio-earum-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@dramaorg/asperiores-optio-earum-pure/actual/is-iterable';
import getIterator from '@dramaorg/asperiores-optio-earum-pure/actual/get-iterator';
import getIteratorMethod from '@dramaorg/asperiores-optio-earum-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/dramaorg/asperiores-optio-earum/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@dramaorg/asperiores-optio-earum`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
